...
export function DemoIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 16 16" fill="currentColor">
      <path d="M0 1.5A1.5 1.5 0 011.5 0h13A1.5 1.5 0 0116 1.5v13a1.5 1.5 0 01-1.5 1.5h-13A1.5 1.5 0 010 14.5v-13zM1.5 1a.5.5 0 00-.5.5V5h14V1.5a.5.5 0 00-.5-.5h-13zM15 6H1v8.5a.5.5 0 00.5.5h13a.5.5 0 00.5-.5V6z" />
      <path d="M2 3a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2z" />
    </svg>
  );
}
